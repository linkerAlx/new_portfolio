      ...
      <main className="w-full h-full flex flex-col  ">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center m-4 space-y-5 lg:space-y-0 lg:space-x-10">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-sm font-bold md:text-base lg:ml-8 bg-gradient-to-br from-black to-[#5F8184] bg-clip-text text-transparent">
              FRONTEND DEVELOPER
            </p>
            <p className="text-center lg:ml-28 font-bold">&</p>
            <p className="text-sm font-bold md:text-base lg:ml-14 bg-gradient-to-br from-black to-[#5F8184] bg-clip-text text-transparent">
              UI/UX DESIGNER
            </p>
          </div>
